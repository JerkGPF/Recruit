...
public class PostAndUserPraticeAdapter extends RecyclerView.Adapter<com.gpfei.recruit.adapters.PostAndUserPraticeAdapter.MyViewHolder> {
    ...
    public PostAndUserPraticeAdapter(Context context, List<Map<String,String>> mapList, String string) {
