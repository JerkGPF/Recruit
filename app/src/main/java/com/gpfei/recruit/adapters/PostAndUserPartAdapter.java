...
import com.gpfei.recruit.beans.PostAndUserPart;

import java.util.ArrayList;
import java.util.List;
import java.util.Map;

public class PostAndUserPartAdapter extends RecyclerView.Adapter<com.gpfei.recruit.adapters.PostAndUserPartAdapter.MyViewHolder> {
    ...
    private PostAndUserPartAdapter.OnItemClickLitener mOnItemClickLitener;

    public void setOnItemClickLitener(PostAndUserPartAdapter.OnItemClickLitener mOnItemClickLitener) {
        this.mOnItemClickLitener = mOnItemClickLitener;
    }

    public PostAndUserPartAdapter(Context context, List<Map<String,String>> mapList, String string) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        System.out.println("holder" + mapList);
